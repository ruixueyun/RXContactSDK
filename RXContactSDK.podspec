...
Pod::Spec.new do |s|
  s.name             = 'RXContactSDK'
  s.version          = '1.0.1'
  s.summary          = 'ruixue contact framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXContactSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXContactSDK.git', :tag => s.version.to_s }
